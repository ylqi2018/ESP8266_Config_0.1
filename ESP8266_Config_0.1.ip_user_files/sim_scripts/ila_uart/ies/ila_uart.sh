...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../ESP8266_Config_0.1.srcs/sources_1/ip/ila_uart/sim/ila_uart.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.ila_uart $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.ila_uart -input simulate.do
}
# Script usage
usage()
{
