...
HD_PWD='D:/Vivado_Program_Files/20170711_ESP8266/ESP8266_Config_0.1/ESP8266_Config_0.1.runs/ila_uart_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_uart.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ila_uart.tcl
